...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen md:grid md:grid-cols-10 flex-col items-center gap-4 p-8 bg-cream text-dark-red">
      ...
      <div className="col-span-4 flex flex-col items-center w-full gap-y-8">
        ...
        <div className="flex gap-x-4 items-center">
          ...
          <h1 className="text-3xl font-bold">Breakfast Realia Review</h1>
        </div>

        {/* Rating feature */}
        <div className="grid grid-cols-2 md:gap-4 gap-2 w-max lg:px-10 sm:px-4 px-2 justify-center items-center">
          {/* Food rating */}
